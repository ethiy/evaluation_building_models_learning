\begin{titlepage}
    ...
    \begin{center}
        \includestandalone[mode=buildmissing, width=\textwidth]{figures/style/cover_logo}
        ...
        \includestandalone[mode=buildmissing, width=\textwidth]{figures/style/cover_image}
