...
\section{Quality evaluation as a classification task}
    ...
    \subsection{Feature extraction}
        ...
        These provide complementary information such as edges (high frequencies, in general) and textures which are suited for inner defect detection as an example (cf. Figure~\ref{fig::fus_2d}).
...
\section{Feature baseline}
    ...
    \subsection{Geometric features}
        ...
        \begin{figure}[htb]
            \centering
            \includestandalone[mode=buildmissing, width=.75\textwidth]{figures/features/geometry/baseline}
            \caption[
    ...
    \subsection{Height based features}
        ...
        \begin{figure}[htb]
            \centering
            \includestandalone[width=\textwidth, mode=tex]{figures/features/height/height_baseline}
            \caption[
    ...
    \subsection{Image based features}
        ...
        \begin{figure}[htb]
            \centering
            \includestandalone[width=\textwidth, mode=buildmissing]{figures/features/image/nadir_projection}
            \caption[
                Nadir projection of \gls{acr::3d} models to image comparison.
            ]{
                \label{fig::nadir_projection}
                Nadir projection of \gls{acr::3d} models to image comparison.
                The input model is projected in the nadir direction.
                It is then superposed on the orthoimage and compared to it.
            }
        \end{figure}
        ...
        This projection is compared with a corresponding orthorectified image \(I_{\mathsf{M}} \in \mathbb{R}^{h_{\mathsf{M}} \times w_{\mathsf{M}} \times 3}\).
                ...
                \floatbox{figure}{
                    \begin{subfloatrow}[2]
                        \ffigbox[.48\textwidth]{
                            ...
                            \includestandalone[mode=buildmissing, width=.45\textwidth]{figures/features/image/edge_image_comparison}
                        }
                        \qquad
                        \ffigbox[.48\textwidth]{
                            \caption{
                            ...
                            \includestandalone[mode=buildmissing, width=.45\textwidth]{figures/features/image/edges_histograms}
                        }
                    \end{subfloatrow}
                }{
                    \caption{
                ...
                \floatbox{figure}{
                    \begin{subfloatrow}[2]
                        \ffigbox[.48\textwidth]{
                            ...
                            \includestandalone[mode=buildmissing, width=.45\textwidth]{figures/features/image/facets_histograms}
                        }
                        \qquad
                        \ffigbox[.48\textwidth]{
                            \caption{
                            ...
                            \includestandalone[mode=buildmissing, width=.45\textwidth]{figures/features/image/whole_histogram}
                        }
                    \end{subfloatrow}
                }{
                    \caption[
...
\section{Implementation details}
    ...
    \subsection{Feature configurations}
        ...
        Actually, using the function \(\chi_{\max,\min,\operatorname{mean},\operatorname{med}}\) defined in Equation~\ref{eq::max_min_mean_med_extractor}, the geometric feature vector in Equation~\ref{eq::geometric_baseline_features} is of dimension
        \begin{equation*}
