...
In the previous chapter (Chapter~\ref{chap::semantic_evaluation}), we developped a heirarchical and modular taxonomy of errors for the overhead imagery modeling case.
...
It casts the problem as a supervized classification one.
...
\section{Quality evaluation as a classification task}
    ...
    \subsection{Different classification problems}
        ...
        \end{equation*}
        Two consecutive classification problems can be concatenated in a heirarchical multi-stage classification:
    ...
    \subsection{Classifier choice}
        ...
        \subsubsection{\acrshort*{acr::svm}}
            ...
            It also manages to learn efficiently on sets with limited sets, as will prove to be the situation (\textit{cf.} Section~\ref{subsec::experiments::datasets::scenes}). 
                ...
                \floatbox{figure}{
                    \begin{subfloatrow}[2]
                        ...
                        \ffigbox[\FBwidth]{
                            ...
                            {\includestandalone[mode=buildnew, width=.45\textwidth]{figures/features/image_based}
                        }
                    \end{subfloatrow}
                }{
...
\section{Advanced features}
    ...
    \subsection{\acrshort*{acr::scatnet} feature extractor}
        ...
        \subsubsection{Height based features}
            ...
            From a practical standpoint, the residuals computed as in Section~\ref{subsec::learned_evaluation::baseline::height} come as images in different sizes \(w_{\mathsf{M}} \times h_{\mathsf{M}}\) (\textit{cf.} Section~\ref{subsec::learned_evaluation::baseline::image}) depending on the input model.
            ...
            \begin{conditions}
                ...
                p_m & is a valid path at layer \(l\) (\textit{cf.} Equation~\ref{eq::scatter_second}). 
            \end{conditions}
        ...
        \subsubsection{Height based features}
            ...
            \begin{description}
                \item[\texttt{Deletion}:] Pixels \(g\) in the corresponding orthoimage which are part of a polygon border (\textit{i.e.} \(Q_{\mathsf{M}}(g) = 1\)) are made black:
                        ...
                        where:
                        \begin{conditions}
                            Q_{\mathsf{M}}^{\otimes 3} = Q_{\mathsf{M}} \otimes Q_{\mathsf{M}} \otimes Q_{\mathsf{M}} & is the tensor obtained by stacking in depth thee copies of the same matrix \(Q_{\mathsf{M}}\);\\
