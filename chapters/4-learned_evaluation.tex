...
\section{\textsc{Feature baseline}}
    ...
    This will be proven later on in Section~\ref{subsec::experiments::evaluation::baseline_feature_analysis}.
...
\section{\textsc{Richer features}}
    ...
    This is discussed in length in Subsection~\ref{subsec::experiments::evaluation::baseline_feature_analysis} and Sections~\ref{sec::more_experiments::finesse} and~\ref{sec::more_experiments::scalability}.\\
    ...
    \subsection{\textsc{Graph-like classification}}
    ...
    \subsection{\textsc{Image-like classification}}
        ...
        \subsubsection{\textsc{Height based features}}
            ...
            Both settings are experimented with and compared later in Chapter~\ref{chap::more_experiments}.\\
