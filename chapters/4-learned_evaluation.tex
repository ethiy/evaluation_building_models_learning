...
\section{\textsc{Feature baseline}}
    ...
    Since there is no comparable work that studied the errors defined in Chapter~\ref{chap::semantic_evaluation}, we propose a baseline for each one of the three modalities: geometric, height based and image based features.
