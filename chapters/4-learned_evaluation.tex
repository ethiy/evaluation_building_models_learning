...
\section{\textsc{Feature baseline}}
    ...
    \subsection{\textsc{Geometric features}}
        ...
        \begin{figure}[htbp]
            \centering
            \includestandalone[mode=tex, width=.75\textwidth]{figures/features/geometric}
            \caption{
    ...
    \subsection{\textsc{Height based features}}
        ...
        \begin{figure}[htpb]
            \centering
            \includestandalone[width=\textwidth, mode=tex]{figures/features/height_based}
            \caption{
                ...
                \floatbox{figure}{
                    \begin{subfloatrow}[2]
                        ...
                        \ffigbox[\FBwidth]{
                            ...
                            {\includestandalone[mode=tex, width=.45\textwidth]{figures/features/radiometric_features}
                        }
                    \end{subfloatrow}
                }{
