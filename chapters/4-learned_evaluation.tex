...
\section{\textsc{Richer features}}
    ...
    \subsection{\textsc{Image classification}}
        ...
        Not a lot of images to learn representations.
        scatnet -> unlearned.

        good with textures.
        finds discrepancy related textures in residuals.
        does not need normalization beforehand.
        resize is worst experimentally.
        different sizes -> vzrying feature vector sizes.
        + a lot of coefficients
        pooling
        S(max, min, median, mean, std)
