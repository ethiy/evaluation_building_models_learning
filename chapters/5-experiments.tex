...
\section{\textsc{Evaluation of the learned approach}}
        ...
        \subsubsection{\textsc{Feature configurations}}
            ...
            \paragraph{Richer features}
                ...
                \begin{itemize}[label=\(\blacktriangleright\)]
                    \item \textbf{S-Hei.} refer to \gls{acr::scatnet} height based features;
                    \item \textbf{S(D)-Im.} (\textit{resp.} \textbf{S(C)-Im.}) correspond to \gls{acr::scatnet} image based features with deletion (\textit{resp.} channel) option;
