    ...
    \subsection{\textsc{Experimental set-up}}
        ...
        \subsubsection{\textsc{Feature configuration}}
            ...
            \paragraph{Baseline features}
                ...
                Actually, using the function \(\chi_{\max,\min,\operatorname{mean},\operatorname{median}}\) defined in Equation~\ref{eq::statistical_extractor}, the geometric feature vector in Equation~\ref{eq::geometric_features} is of dimension
                \begin{equation*}
                    \underbrace{4}_{\substack{\text{the output dimension}\\\text{of the function } \chi_{\max,\min,\operatorname{mean},\operatorname{median}} }} \times \underbrace{5}_{\substack{\text{the number of the facet}\\\text{graph attributes}}} = 20.
                \end{equation*}
