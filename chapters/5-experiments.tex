    ...
    \subsection{\textsc{Error statistics}}
        ...
        \begin{figure}[htpb]
            ...
            \ffigbox[\textwidth]{
                ...
                \caption{
                    \label{fig::lod1_errors}
                    Occurence statistics for \texttt{Building errors} depending on the studied area.
                }
            }
        \end{figure}
        \begin{sidewaysfigure}[htpb]
            \centering
            \ffigbox[\textwidth]{
                \includestandalone[mode=buildnew, height=.7\textheight]{figures/datasets/families_stats}
            }{
                \caption{
                    \label{fig::lod2_errors}
                    Occurence statistics for \texttt{Facet errors} depending on the studied area.
                }
            }
        \end{sidewaysfigure}
        ...
        Figures~\ref{fig::family_errors},~\ref{~\ref{fig::lod1_errors}} and~\ref{fig::lod2_errors} reports modeling errors statistics over the annotated buildings.\\
