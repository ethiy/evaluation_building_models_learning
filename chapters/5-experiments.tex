...
\section{Datasets}
    ...
    Next, in Section~\ref{subsec::experiments::datasets::stats}, we analyse the distribution of the previously defined errors (\textit{cf.} Chapter~\ref{chap::semantic_evaluation}) over the three urban areas of interest.
    ...
    \subsection{Urban scenes and modeling techniques}
        ...
        In order to handle these models, \verb!proj.city!\footnote{
            \href{https://github.com/ethiy/proj.city.git}{A library for 3D city model projection.}
    ...
    \subsection{Classification settings}
        ...
        \subsubsection{Classifiers}
            ...
            \paragraph{\acrshort*{acr::svm}}
                ...
                It was the only method, to our knowledge that was readily available library in Python\footnote{\href{https://github.com/IvanoLauriola/MKLpy}{MKLpy}}.
...
\section{Baseline feature analysis}
    ...
    \subsection{Overview}
        \label{subsec::experiments::baseline_feature_analysis::overview}
        ...
        \begin{itemize}[label=\(\blacktriangleright\)]
            \item \gls{acr::rmse} fails completly to predict errors defined in our taxonomy;
            \item \texttt{Building errors} are better detected on \textbf{Elancourt} than on the other scenes;
            \item \texttt{FOS} is very well detected with over \SI{95}{\percent} F-score, over all areas of interest;
