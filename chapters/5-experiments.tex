        ...
        \subsubsection{\textsc{Feature importance}}
            ...
            \begin{figure}[htpb]
                ...
                \ffigbox[\FBwidth]{
                    \begin{subfloatrow}
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=buildnew, height=.23\textheight]{figures/results/feature_importance/building}
                        }{
                            \caption{
                        ...
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=buildnew, height=.23\textheight]{figures/results/feature_importance/facet}
                        }{
                            \caption{
