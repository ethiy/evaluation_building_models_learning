...
\section{\textsc{Pipeline evaluation}}
    ...
    In Chapters~\ref{chap::semantic_evaluation} and~\ref{chap::learned_evaluation}, we proposed a semantic quality evaluation of building \gls{acr::3d} models through classification.
    In the last section, we explained how we acquired our dataset, in addition to analysing the effect of the urban scene on error statistics.\\
    ...
    \subsection{\textsc{Baseline feature analysis}}
        ...
        \subsubsection{\textsc{Feature ablation study}}
            ...
            The second is made clear by the difference in roof colors, in dense uniform settings (Figure~\ref{subfig::bus_2d}).
