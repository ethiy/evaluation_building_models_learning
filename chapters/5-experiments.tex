...
\section{\textsc{Datasets}}
    ...
    \subsection{\textsc{Error statistics}}
        ...
        \begin{figure}[htpb]
            ...
            \ffigbox[\textwidth]{
                \begin{subfloatrow}
                    ...
                    \ffigbox[\textwidth]{
                        ...
                        \caption{
                            ...
                            Occurence statistics for \texttt{Building errors} depending each area.
                        }
                    }
                \end{subfloatrow}
                \vskip1em
                \begin{subfloatrow}
                    \centering
                    \ffigbox[\textwidth]{
                        \includestandalone[mode=buildnew, height=7.5cm]{figures/datasets/lod2_stats}
                    }{
                        \caption{
                            \label{subfig::lod2_errors}
                            Occurence statistics for \texttt{Facet errors} depending each area.
                        }
                    }
                \end{subfloatrow}
            }{
                ...
                \caption{
                    Error statistics depending at \texttt{finesse} level 3.
        ...
        Figures~\ref{fig::family_errors} and ~\ref{fig::error_statistics} reports modeling errors statistics over the annotated buildings.\\
