    ...
    \subsection{Urban scenes and modeling techniques}
        ...
        \begin{figure}[htb]
            \ffigbox[\textwidth]{
                \begin{subfloatrow}[3]
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/datasets/elancourt_samples}
                    }{
                        \caption{
                    ...
                    \quad
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/datasets/nantes_samples}
                    }{
                        \caption{
                    ...
                    \quad
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/datasets/paris-13_samples}
                    }{
                        \caption{
        ...
        \begin{figure}[htb]
            ...
            \ffigbox[\textwidth]{
                \begin{subfloatrow}[3]
                    \centering
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/bati3d/plane_detection}
                    }{
                        \caption{
                    ...
                    \quad
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/bati3d/plane_arrangements}
                    }{
                        \caption{
                    ...
                    \quad
                    \ffigbox[.31\textwidth]{
                        \includegraphics[width=.27\textwidth]{images/bati3d/bati3d}
                    }{
                        \caption{
                            \label{subfig::bati3d}
        ...
        \begin{figure}[htb]
            ...
            \ffigbox[\textwidth]{
                \begin{subfloatrow}[2]
                    \centering
                    \ffigbox[.48\textwidth]{
                        \includestandalone[mode=buildmissing, height=6cm]{figures/datasets/families_stats}
                    }{
                        \caption{
                    ...
                    \quad
                    \ffigbox[.48\textwidth]{
                        \includestandalone[mode=buildmissing, height=6cm]{figures/datasets/lod1_stats}
                    }{
                        \caption{
