...
\section{Datasets}
    ...
    \subsection{Urban scenes and modelling techniques}
        ...
        \gls{acr::3d} models were generated using the algorithm described in~\parencite{durupt2006}, out of existing building footprints and aerial VHR multi-view \glspl{acr::dsm}.
...
\section{Pipeline evaluation}
    \subsection{Experimental set-up}
        ...
        Precision indicates how much samples, amongst the detected ones, were, in truth, part of the studied class~\parencite{Powers}.
