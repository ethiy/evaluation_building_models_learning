...
First, in Section~\ref{sec::experiments::datasets}, we delineate how the building models that are used for the study.
Second and last, Section~\ref{sec::experiments::baseline_feature_analysis} provides a first experimental outlook of the capacity of our approach to detect errors affecting \gls{acr::3d} building models.
...
\section{Datasets}
    ...
    \subsection{Urban scenes and modeling techniques}
        ...
        Figure~\ref{fig::elancourt_ortho} depicts the small city of \textbf{Elancourt} which contains diverse of building types: residential areas with gable and hip roof buildings and districs with large industrial flat roof buildings (cf. Figure~\ref{subfig::elancourt_samples}).
        ...
        In order to handle these models, \verb!proj.city!\footnote{
            \href{https://github.com/ethiy/proj.city}{\verb!proj.city!: \url{https://github.com/ethiy/proj.city.git}}
        }, a C++ library, was developed making use of the CGAL library~\parencite{fabri2000design}.
    ...
    \subsection{Error statistics}
        ...
        This was possible thanks to the work\footnote{\href{https://github.com/CHUPClem/sGrISner}{\verb!sGrISner!: \url{https://github.com/CHUPClem/sGrISner}}} of Clémence Chupin, who was a Master student at \gls{acr::ensg}.
    ...
    \subsection{Classification settings}
        ...
        \subsubsection{Classifiers}
            ...
            \paragraph{\acrshort*{acr::svm}}
                ...
                It was the only method, to our knowledge, that was readily available as a library in Python\footnote{\verb!MKLpy! \href{https://github.com/IvanoLauriola/MKLpy}{\url{https://github.com/IvanoLauriola/MKLpy}}}.
