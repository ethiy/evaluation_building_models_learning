...
\section{Evaluation using \texorpdfstring{\acrshort{acr::scatnet}}{ScatNet} and graph kernels}
    ...
    \subsection{\texorpdfstring{\acrshort*{acr::scatnet}}{ScatNet} feature extractor}
        ...
        \subsubsection{Image based features.}
            ...
            In fact, as shown in Figure~\ref{fig::bus_2d}, image textures could be also useful for error detection.
            ...
            \begin{figure}[htb]
                \centering
                \includestandalone[width=\textwidth, mode=buildmissing]{figures/features/image/deletion}
                \caption[
            ...
            \begin{figure}[hbt]
                \centering
                \includestandalone[width=\textwidth, mode=buildmissing]{figures/features/image/channel}
                \caption[
