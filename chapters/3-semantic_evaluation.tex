...
\section{\textsc{The general framework}}
    ...
    In the same subsection, we discussed the desired properties in order to achieve a large-scale and automatic semantic evaluation.
    ...
    \subsection{\textsc{Hierarchization and modularity}}
        ...
        These are directly linked to the large-scale aspect of the evaluation approach.
        ...
        \subsubsection{\textsc{The generalizability \textit{vs.} exhaustivity compromise}}
            In Subsection~\ref{subsec::introduction::contributions::positioning}, we have seen how the large-scale constraint on the quality evaluation approach entails the method robustness to changes in the urban scene as well as to the pipeline behind the evaluated model.
    ...
    \subsection{\textsc{Atomic error definitions}}
        ...
        \subsubsection{\texttt{Building Errors} \textsc{family}}
            ...
            \paragraph{\texttt{\acrlong*{acr::bit}}}
                ...
                \begin{itemize}
                    \item missing inner court: corresponds to a missing hole (\textit{c.f.} Subfigure~\ref{subfig::building_hole});
...
\section{\textsc{Parametric label extraction}}
    ...
    \subsection{\textsc{Evaluation parameters}}
        ...
        This would usefull in the case where the quality evaluation is used by a correction module, either manually or automatically operated.
