    ...
    \subsection{\textsc{Atomic error definitions}}
        ...
        \subsubsection{\texttt{Facet Errors} \textsc{family}}
                        ...
                        \begin{subfloatrow}
                            ...
                            \ffigbox[0.5\textwidth]{
                                ...
                                \caption{
                                    ...
                                    The erroneous facet is colored in olive.
                                }
                            }
                        \end{subfloatrow}
                        \vskip1em
            ...
            \paragraph{\texttt{\acrlong*{acr::fib}}}
                ...
                As en example, Subfigure~\ref{subfig::fib_2d} shows that the central edge that links the two main roof sides does not correspond to the one on the image position.
