    ...
    \subsection{\textsc{Atomic error definitions}}
        ...
        \subsubsection{\texttt{Facet errors} \textsc{family}}
            ...
            \paragraph{\texttt{\acrlong*{acr::fib}}}
                ...
                The most likely reason usually behind this kind of errors are usually imprecise fitting of primitives that lead to a shifted intersecting edge such as shown in Subfigure~\ref{subfig::fib::2d}.\\
            ...
            \paragraph{\texttt{\acrlong*{acr::fig}}}
                ...
                This is linked in particular to the input data quality.
                ...
                This can be detected by taking into account semantics and detecting such cases in order to cast away the corruption for a correct estimation or by relying on the human operator intervention.
