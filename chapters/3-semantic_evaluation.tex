...
\section{\textsc{The general framework}}
    ...
    \subsection{\textsc{Hierarchization and modularity}}
        ...
        \subsubsection{\textsc{The generalizability \textit{vs.} exhaustivity compromise}}
    ...
    \subsection{\textsc{A general classification of errors}}
        ...
        \begin{figure}[htbp]
            \begin{center}
                \includestandalone[mode=tex, width=\textwidth]{figures/taxonomy_tree}
                \caption{
                    \label{fig::taxonomy} 
    ...
    \subsection{\textsc{Atomic error definitions}}
        ...
        \subsubsection{\texttt{Building Errors} \textsc{family}}
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/bos}
                            }{
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/bus}
                            }{
                                \label{subfig::bus_3d}
                                \caption{
            ...
            \paragraph{\texttt{\acrlong*{acr::bib}}}
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/correct_bib}
                            }{
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/bib}
                            }{
                                \label{subfig::bib_3d}
                                \caption{
            ...
            \paragraph{\texttt{\acrlong*{acr::bit}}}
                ...
                \begin{itemize}
                    \item missing inner court: corresponds to a missing hole (\textit{cf.} Subfigure~\ref{subfig::building_hole});
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/correct_bit}
                            }{
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/bit}
                            }{
                                \label{subfig::bit_3d}
                                \caption{
            ...
            \paragraph{\texttt{\acrlong*{acr::big}}}
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/correct_big}
                            }{
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/building/big}
                            }{
                                \label{subfig::big_3d}
                                \caption{
            ...
            \paragraph{\texttt{\acrlong*{acr::fus}}}
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/correct_fos_fus_fib_fig}
                            }{
                                \label{subfig::gt_fus_3d}
                                \caption{Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/fus}
                            }{
                                \label{subfig::fus_3d}
                                \caption{
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/fos}
                            }{
                                \label{subfig::fos_3d}
                                \caption{
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/fib}
                            }{
                                \label{subfig::fib_3d}
                                \caption{
            ...
            \paragraph{\texttt{\acrlong*{acr::fit}}}
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/correct_fit}
                            }{
                                \label{subfig::gt_fit_3d}
                                \caption{Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/fit}
                            }{
                                \label{subfig::fit_3d}
                                \caption{
                ...
                \begin{figure}[htbp]
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            ...
                            \ffigbox[0.5\textwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/facet/fig}
                            }{
                                \label{subfig::fig_3d}
                                \caption{
        ...
        \subsubsection{\textsc{Error taxonomy properties}}
            ...
            \begin{figure}[htbp]
                ...
                \ffigbox[\FBwidth]{
                    \begin{subfloatrow}[2]
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/holes/building}
                        }{
                        ...
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=tex, width=.45\textwidth]{figures/errors/holes/facet}
                        }{
