    ...
    \subsection{\textsc{Atomic error definitions}}
        ...
        \subsubsection{\texttt{Building Errors} \textsc{family}}
            ...
            \paragraph{\texttt{\acrlong*{acr::bit}}}
                ...
                \begin{description}
                    \item[Missing inner court:] It corresponds to a missing hole;
                    \item[Inaccurate border shape:] It is due to a wrong primitive fitting: the shape of the footprint can be better described by a different geometrical shape.
                            Subfigure~\ref{subfig::bit_2d} gives an example where the polygon has a wrong number of sides.
        ...
        \subsubsection{\texttt{Facet Errors} \textsc{family}}
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                ...
                                \caption{\label{subfig::gt_fus_3d} Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                ...
                                \caption{\label{subfig::gt_fos_3d} Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
            ...
            \paragraph{\texttt{\acrlong*{acr::fib}}}
                ...
                As an example, Subfigure~\ref{subfig::fib_2d} shows that the central edge that links the two main roof sides does not correspond to the one on the image position.
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                ...
                                \caption{\label{subfig::gt_fib_3d} Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
                    ...
                    \ffigbox[\textwidth]{
                        \begin{subfloatrow}
                            \ffigbox[0.5\textwidth]{
                                ...
                                \caption{\label{subfig::gt_fit_3d}Ground truth \gls{acr::3d} model.}
                            }
                            \ffigbox[0.5\textwidth]{
            ...
            \paragraph{\texttt{\acrlong*{acr::fig}}}
                ...
                In Subfigure~\ref{subfig::fig_3d}, the planar surface slope was miscalculated as flat while it was of \textit{ca.} \SI{25}{\degree}.\\
