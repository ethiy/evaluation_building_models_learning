    ...
    \subsection{\textsc{\acrshort*{acr::svm} compared to \acrshort*{acr::rf}}}
        \begin{table}[htpb]
            ...
            \begin{center}
                \begin{tabular}{| c | c c | c c | c c | c c |}
                    ...
                    \hline
                    \texttt{FIB} & \textbf{9.17} & 87.5 & 0 & ---
                    & 8.30 & 82.61 & 7.42 & \textbf{100} \\
                    \hline
        ...
        \begin{figure}[htpb]
            ...
            \ffigbox[\FBwidth]{
                \begin{subfloatrow}[2]
                    \ffigbox[\FBwidth]{
                        \includestandalone[mode=buildnew, width=.45\textwidth]{figures/results/svm_rf/feature_importance/building}
                    }{
                        \caption{
                    ...
                    \ffigbox[\textwidth]{
                        \includestandalone[mode=buildnew, width=.45\textwidth]{figures/results/svm_rf/feature_importance/facet}
                    }{
                        \caption{
                ...
                \caption{
                    \label{fig::feature_importances} Modality contribution for the \gls{acr::svm} classifier based on the coefficients computed by EasyMKL.
