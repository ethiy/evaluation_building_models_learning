...
\section{\textsc{Automatic Building \texorpdfstring{\gls*{acr::3d}}{3D} modeling}}
    ...
    \subsection{\textsc{Building extraction}}
    ...
    \subsection{\textsc{Modeling strategies}}
    ...
    \subsection{\textsc{Supervised classifiers}}
        ...
        \subsubsection{\textsc{\acrlong*{acr::svm}}}
            ...
            \paragraph{Hard margin}
                ...
                \begin{figure}
                    \centering
                    \includestandalone[mode=tex, width=\textwidth]{figures/svm/linear_separable}
                    \caption[
            ...
            \paragraph{Soft margin}
                ...
                \begin{figure}
                    \centering
                    \includestandalone[mode=tex, width=\textwidth]{figures/svm/non_linear_separable}
                    \caption[
            ...
            \paragraph{Kernel \acrshort*{acr::svm}}
                ...
                \begin{figure}
                    ...
                    \ffigbox[\FBwidth]{
                        \begin{subfloatrow}[2]
                            \ffigbox[\FBwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/svm/circles_original}
                            }{
                                \caption{
                            ...
                            \ffigbox[\FBwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/svm/circles_polar}
                            }{
                                \caption{
        ...
        \subsubsection{\textsc{Random forest}}
            ...
            \paragraph{Decision tree classifier}
                \begin{figure}[htbp]
                    \centering
                    \includestandalone[mode=tex, width=\textwidth]{figures/random_forest/decision_tree}
                    \caption[
            ...
            \paragraph{Bagging decision trees}
                \begin{figure}
                    \centering
                    \includestandalone[mode=tex, height=.4\textheight]{figures/random_forest/ensemble}
                    \caption[
                ...
                \begin{figure}
                    ...
                    \ffigbox[\FBwidth]{
                        \begin{subfloatrow}[2]
                            \ffigbox[\FBwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/random_forest/circles_dt}
                            }{
                                \caption{
                            ...
                            \ffigbox[\FBwidth]{
                                \includestandalone[mode=tex, width=.45\textwidth]{figures/random_forest/circles_rf}
                            }{
                                \caption{
                ...
                Random forest do not only rely on a simple bagging but also on a second random sampling: this time it is on the feature dimensions.
        ...
        \subsubsection{\textsc{\acrlong*{acr::scatnet} for image classification}}
            ...
            \paragraph{\gls*{acr::scatnet}: a reverse engineered \gls*{acr::cnn}}
                ...
                \subparagraph{Scattering coefficients}
                    ...
                    \begin{figure}
                        \centering
                        \includestandalone[mode=tex, width=\textwidth]{figures/scattering_network}
                        \caption[
