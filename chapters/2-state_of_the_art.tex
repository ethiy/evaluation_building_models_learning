...
\section{\textsc{Automatic Building \texorpdfstring{\gls*{acr::3d}}{3D} modeling}}
    ...
    \subsection{\textsc{Building extraction}}
        ...
        The first relies on retrieving building footprints out of a \gls{acr::gis} database, such as cadastral ones~\parencite{durupt2006automatic,biljecki2017generating,biljecki2019raise,taillandier2004automatic,ledoux2011topologically}.
        ...
        Both approaches suffer from shortcomings.\\
    ...
    \subsection{\textsc{Modeling strategies}}
        ...
        Once the building footprint is extracted, the goal is to generalize the surface of the building out of the input data.
        Several strategies are conducted.
        They can be classified in three categories: Top-down, bottom-up and mixed approaches.\\
