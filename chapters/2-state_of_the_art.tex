...
\section{\textsc{Quality evaluation of \texorpdfstring{\gls*{acr::3d}}{3D} building models}}
    ...
    \subsection{\textsc{Output types}}
        ...
        \subsubsection{\textsc{Fidelity metrics based methods}}
            ...
            Edges related metrics are also used as a intermediary as shown by~\textcite{elberink2011quality} and~\textcite{michelin2013quality}.
    ...
    \subsection{\textsc{Reference data types}}
        ...
        \subsubsection{\textsc{High resolution ground truth}}
            ...
            \textcite{dick2004modeling}, for instance, evaluated their buildings based on manual tape measurements taken on specific architectural features, like windows and columns, with an accuracy of \SI{0.01}{\m} for the first and \SI{0.1}{\m} for the second.
