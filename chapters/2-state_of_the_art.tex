...
\section{\textsc{Supervised learning and pattern recognition}}
    ...
    \subsection{\textsc{Feature extraction}}
        ...
        \subsubsection{\textsc{Kernels for graph classification}}
            ...
            As accustomed in statistical learning, one way to alleviate representation issues for data is to directly compare graphs using kernels as seen previously in sub-subsection~\ref{subsubsec::}.
