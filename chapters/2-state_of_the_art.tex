...
\section{Automatic \texorpdfstring{\gls*{acr::3d}}{3D} building modeling}
    ...
    \subsection{Modeling strategies}
        ...
        \subparagraph{Model-driven approaches}
            This type of methods, also called top-down, rely on strong assumptions on the type of buildings to be modeled.
...
\section{Quality evaluation of \texorpdfstring{\gls*{acr::3d}}{3D} building models}
    ...
    \subsection{Types of reference data}
        ...
        \subsubsection{Remote sensing data}
            ...
            \subparagraph{Aerial images}
                ...
                Based on these segments,~\textcite{boudet2006supervised} not only evaluates edges but also corners (i.e., edge intersections) and planes.
    ...
    \subsection{Novelty of the proposed method}
        ...
        Our work relies on the same idea, but goes farther by allowing the possibility to evaluate building models without using any reference data\footnote{With the exception of training data.} and relying on their intrinsic attributes instead.
        ...
        Finally, we made use of some advanced feature extractors in the aims of improving the prediction scores of the proposed pipeline.
