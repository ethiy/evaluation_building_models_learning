...
\section{Supervised learning and pattern recognition}
    ...
    \subsection{Supervised classifiers}
        ...
        \subsubsection{Random forest}
            ...
            We end this subsubsection discussing some random forests properties.
            ...
            \paragraph{Bagging decision trees}
                ...
                \begin{figure}
                    \centering
                    \begin{subfigure}{.48\textwidth}
                        \includestandalone[mode=buildnew, width=\textwidth]{figures/random_forest/circles_dt}
                        \caption{
                            \label{fig::decision_tree_circles} Decision tree separator.
                        }
                    \end{subfigure}
                    \begin{subfigure}{.48\textwidth}
                        \includestandalone[mode=buildnew, width=\textwidth]{figures/random_forest/circles_rf}
                        \caption{
