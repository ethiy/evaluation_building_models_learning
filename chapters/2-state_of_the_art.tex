...
\section{\textsc{Supervised learning and pattern recognition}}
    ...
    \subsection{\textsc{Supervised classifiers}}
        ...
        \subsubsection{\textsc{\acrlong*{acr::rf}}}
            ...
            \paragraph{Bagging decision trees}
                ...
                \begin{figure}
                    ...
                    \ffigbox[\FBwidth]{
                        ...
                        \caption[
                            Difference between a single decision tree and a \gls{acr::rf} visualized in feature space for a generated toy data.
                        ]{
                            \label{fig::decision_tree_vs_rf}
                            Difference between a single decision tree and a \gls{acr::rf} visualized in feature space for a generated toy data.
                            We see how a \gls{acr::rf} aggregates multiple shallow decision trees in order to achieve a good generalization power instead of overfitting to the sampled data.
                        }
                    }
                \end{figure}
