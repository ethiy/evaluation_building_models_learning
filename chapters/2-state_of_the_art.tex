...
\section{\textsc{Supervised learning and pattern recognition}}
    ...
    \subsection{\textsc{Feature extraction}}
        ...
        \subsubsection{\textsc{\acrlong*{acr::scatnet} for image classification}}
            ...
            Let $x: u \mapsto x(u)$ be an image (or any signal in general) and $G$ a group such as a translation group on the signal domain.
            ...
            The non-linearity, just as in \glspl{acr::cnn}, is necessary in order to obtain interesting non-linear representations.\\
