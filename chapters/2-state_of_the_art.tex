...
\section{\textsc{Quality evaluation of \texorpdfstring{\gls*{acr::3d}}{3D} building models}}
    ...
    \subsection{\textsc{Novelty of the proposed method}}
        ...
        On the other hand, the need for reasonably available reference data, which is dictated by the \textbf{large-scale} constraint, implies the reliance on remote sensing data based methods (\textit{c.f.} Subsection~\ref{subsec::state_of_the_art::quality::reference}).\\
