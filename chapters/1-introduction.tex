...
\section{Evaluating building models}
    ...
    We have just seen how building model quality evaluation can is one the main challenges in the field.
    In this section, are presented the different types of evaluation that a building model can undergo.
    First, in section~\ref{sec::introduction::building_model_evaluation::consistancy}, is described how models could be checked for their geometric consistancy.
    Second, manual inspection is discussed, in section~\ref{sec::introduction::building_model_evaluation::manual}.
    Third and last, is considered automatic evaluation and its challenges.
