...
\section{Contributions}
    ...
    To do so, the context of the this work is explained in detail in subsection~\ref{}.
    Further on, promising and conceivable utilizations are stated in subsection~\ref{}.
    This is before ending with a summary of the principal contributions that this work presents (\textit{c.f.} subsection~\ref{}).
