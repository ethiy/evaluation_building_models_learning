...
\section{Urban \texorpdfstring{\acrshort*{acr::3d}}{3D} reconstruction}
    ...
    \subsection{\texorpdfstring{\gls*{acr::3d}}{3D} building modeling}
        ...
        \subsubsection{Large-scale outdoor city modeling}
            ...
            \footnotetext{
                \href{http://www.itowns-project.org}{iTowns: \url{http://www.itowns-project.org}.}
            }
            \addtocounter{footnote}{1}
            \footnotetext{
                \href{https://umrlastig.github.io/adevaux_homepage/}{Alexandre Devaux website: \url{https://umrlastig.github.io/adevaux_homepage/}.}
            }
        ...
        \subsubsection{Building \texorpdfstring{\gls*{acr::3d}}{3D} models meets semantics}
            ...
            That is why the last criterion was used, for example, in addition to the \gls{acr::rmse}, as an evaluation metric in~\textcite{lafarge2012creating}.\\
