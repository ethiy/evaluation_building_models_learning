    ...
    \subsection{Applications of urban \gls*{acr::3d} models}
        ...
        \subsubsection{Entertainement related challenges}
            ...
            \begin{figure}[htpb]
                ...
                \caption{
                    \label{fig::augemented_reality} Virtual vizualization of sewers in Paris based on the \gls{acr::3d} model of the city (image courtesy of \href{http://recherche.ign.fr/labos/matis/~devaux}{Alexandre Devaux }).
                }
            \end{figure}
    ...
    \subsection{Obstacles in building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Data acquisition}
            ...
            \begin{figure}[htpb]
                ...
                \caption{
                    \label{fig::3d_model_terrestrial_registration} Terrestrial \gls{acr::lidar} point clouds can be registred against building \gls{acr::3d} models~\parencite{monnier2014}.
        ...
        \subsubsection{Modeling automation}
            ...
            a geographic proximity does not imply always a temporal closeness for buildings as depicted in Figure~\ref{subfig::xiiith_paris_haussmann_tower}.
