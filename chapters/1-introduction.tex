...
\section{\textsc{Urban \texorpdfstring{\gls*{acr::3d}}{3D} reconstruction}}
    ...
    \subsection{\textsc{Building \texorpdfstring{\gls*{acr::3d}}{3D} modeling}}
        ...
        \subsubsection{\textsc{Building \texorpdfstring{\gls*{acr::3d}}{3D} models meets semantics}}
            ...
            That is why the last criteria was used, for example, in addition to the \gls{acr::rmse}, as an evaluation metric in~\textcite{lafarge_ijcv12}.\\
