...
\section{Urban \acrshort*{acr::3d} reconstruction}
    ...
    \subsection{Building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Building \gls*{acr::3d} models meets semantics}
            ...
            Different strategies are used in building \gls{acr::3d} modeling.
            Each method, balancing between compacity and geometric accuracy, targets a specific model resolution.
