...
\section{Urban \acrshort*{acr::3d} reconstruction}
    ...
    \subsection{Building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Building \gls*{acr::3d} models meets semantics}
            ...
            In fact, architectural elements correspond usually to a single and simple geometric shape, that is mostly planar.
...
\section{Evaluating building models}
    ...
    \subsection{Topological consistancy inspection}
        ...
        However, this standard is not always respected, as shown in~\textcite{biljecki2016most}, where up to 89\% of models are invalid.\\

        For the purpose of automatically checking the topological consistancy of city models, a sizable number of approaches have been proposed.
        It has been a steady progress over a long period of time.
        The common principle in these methods was the 2-manifoldness of objects~\parencite{ledoux2013validation}.
        However, the first ones did not explore all topological possiblities provided by the standard~\parencite{biljecki2016most, ledoux2013validation}.
        In fact, 
