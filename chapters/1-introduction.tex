...
\section{Evaluating building models}
    ...
    \subsection{Geometric inspection}
        ...
        \subsubsection{Automatic evalutation}
            ...
            As discussed, the models in question possess high semantic properties that has a sizable effect on their geometry.
            Assessing one without doing so to the other is fundamentally unsound.
