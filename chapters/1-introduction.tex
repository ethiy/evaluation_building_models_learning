...
\section{Urban \acrshort*{acr::3d} reconstruction}
    ...
    \subsection{Obstacles in building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Quality evaluation}
            ...
            Usually, it is indirectly checked using the compacity criterium~\parencite{lafarge_ijcv12}.\\
...
\section{Evaluating building models}
    ...
    In this section, are presented the different types of evaluation that a building model can undergo.
    First, in susection~\ref{sec::introduction::building_model_evaluation::consistancy}, is described how models could be checked for their geometric consistancy.
    Second, manual inspection is discussed, in subsection~\ref{sec::introduction::building_model_evaluation::manual}.
    Third and last, subsection~\ref{sec::introduction::building_model_evaluation::automatic} considers automatic evaluation and its challenges.
    \subsection{Topological consistancy inspection}
        \label{sec::introduction::building_model_evaluation::consistancy}
        ...
        However, in practice, it is not always respected, as shown in~\textcite{biljecki2016most}, where up to 89\% of models are invalid.\\
        In consequence, the subject of automatically checking the topological consistancy of city models has drawn a sizable amount of attention in the \gls{acr::gis} community.
        The basic common principle is the two-manifoldness of surface representations, as shown in~\textcite{groger2011achieve}, with the aim of excluding self-intersections.
        It is however not sufficient to correctly model complex buildings.
        The latter can be, in reality, represented as an agregation of two-manifold surfaces, as shown in~\textcite{groger2011achieve, ledoux2013validation}.\\
        However, not all efforts did explore the topological possiblities that are provided by the standard~\parencite{biljecki2016most, ledoux2013validation}.
...
\section{Contributions}
    ...
    \subsection{Positioning}
        ...
        Errors def \& detec independent from: LoD, modeling method and urban scene.
