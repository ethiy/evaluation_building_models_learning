...
\section{Urban \gls*{acr::3d} reconstruction}
    ...
    \subsection{Obstacles in building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Modeling automation}
            ...
            At a regional or continental scale, the differences become even more overt: \textit{c.f.} Figure~\ref{fig::different_regions}.
...
\section{Evaluating building models}
    ...
    \subsection{Geometric inspection}
        ...
        \subsubsection{Automatic evalutation}
            In order to achieve scalability, the get-go solution is automation.
...
\section{Contributions}
    ...
    \subsection{Positioning}
        ...
        Building model evaluation is, herein, studied under two constraints: large scale and automation.
