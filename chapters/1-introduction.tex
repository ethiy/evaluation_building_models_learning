...
\section{Urban \acrshort*{acr::3d} reconstruction}
    ...
    \subsection{Applications of urban \gls*{acr::3d} models}
        ...
        \subsubsection{Administration related challenges}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{images/3d_model_applications/3d_cadastre}
        ...
        \subsubsection{Urban planning related challenges}
            ...
            \begin{figure}[htpb]
                \centering
                \includegraphics[width=\textwidth]{images/3d_model_applications/simplu}
                \caption{
                    \label{fig::3d_simulation} Example of \gls{acr::3d} urban scene simulated from known urban norms~\parencite{brasebin2017stochastic}.
    ...
    \subsection{Building \gls*{acr::3d} modeling}
        ...
        \subsubsection{Large scale outdoor city modeling}
            ...
            First, urban element are grouped into different groups depending on how fast they undergo change.
            Producing \gls{acr::3d} models  is discussed along this mentionned categorization.
            ...
            One would only need to detect its class and reconstruct it, accordingly, using a generic \gls{acr::cad} model portaying the same meaning.\\

            Based on the previous temporal frequency differentiation analysis, we narrowed down the urban elements that need care in modeling to two: buildings and bridges. 
