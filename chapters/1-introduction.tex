...
\section{\textsc{Urban \texorpdfstring{\acrshort*{acr::3d}}{3D} reconstruction}}
    ...
    \subsection{\textsc{Applications of urban \texorpdfstring{\gls*{acr::3d}}{3D} models}}
        ...
        A more comprehensive study was presented in~\textcite{biljecki2015applications}.
        ...
        \subsubsection{\textsc{Building \texorpdfstring{\gls*{acr::3d}}{3D} models meets semantics}}
            ...
            \begin{figure}
                \begin{center}
                    \ffigbox{
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=tex, width=.7\textwidth]{figures/model_vs_mesh/mesh_model}
                        }{
                            \caption{3D mesh of a building surface ($\approx$ \num[output-exponent-marker = \text{e}]{1e5} triangles).}
                        }
                        \ffigbox[\FBwidth]{
                            \includestandalone[mode=tex, width=.7\textwidth]{figures/model_vs_mesh/ground_truth_model}
                        }{
    ...
    \subsection{\textsc{Obstacles in building \texorpdfstring{\gls*{acr::3d}}{3D} modeling}}
        ...
        \subsubsection{\textsc{Modeling automation}}
            ...
            \begin{figure}[htpb]
                \centering
                \includestandalone[mode=tex, width=\textwidth]{figures/modeling_approaches}            
                \caption[
...
\section{\textsc{Contributions}}
    ...
    \subsection{\textsc{Main contributions}}
        ...
        \begin{figure}[htpb]
            \centering
            \includestandalone[mode=tex, width=\textwidth]{figures/graphical_abstract/graphical_abstract}            
            \caption[
