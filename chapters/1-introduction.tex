...
\section{\textsc{Urban \texorpdfstring{\acrshort*{acr::3d}}{3D} reconstruction}}
    ...
    \subsection{\textsc{Applications of urban \texorpdfstring{\gls*{acr::3d}}{3D} models}}
        ...
        \subsubsection{\textsc{Urban planning related challenges}}
            ...
            The \index{vizualization} vizualization and \index{simulation}simulation of urban zones can be equally helpfull for \index{public consultation}public consultation~\parencite{wu2010virtual}.\\
    ...
    \subsection{\textsc{Obstacles in building \texorpdfstring{\gls*{acr::3d}}{3D} modeling}}
        ...
        \subsubsection{\textsc{Modeling automation}}
            ...
            At a regional or continental scale, the differences become even more overt: \textit{cf.} Figure~\ref{subfig::different_regions}.
            ...
            \begin{figure}[htpb]
                \ffigbox[\FBwidth]{
                    ...
                    \caption{
                        \label{fig::different_styles}
                        Building architecture shows high heterogenuity not only across different regions, but also in the same urban scene.
                    }
                }
            \end{figure}
...
\section{\textsc{Contributions}}
    ...
    This is before ending with a summary of the main contributions of this work (\textit{cf.} Subsection~\ref{sec::introduction::contributions::contributions}).
...
\section{\textsc{Structure of the Thesis}}
    ...
    \begin{itemize}[label=\(\blacktriangleright\)]
        ...
        \item \textbf{Automation}, which is the second and remaining constraint defined in Subsection~\ref{subsec::introduction::contributions::positioning}, is handled in Chapter~\ref{chap::learned_evaluation}.
        ...
        \item Chapter~\ref{chap::more_experiments} compiles results from multiple experiments that further tests the pipeline.
                To satisfy the already stated \textbf{large-scale} need (\textit{cf.} Subsection~\ref{subsec::introduction::contributions::positioning}), a scalability analysis is drawn based on various experiments involving the presented urban zones.
                ...
                Finally, a thorough testing of richer features, which take into account the structural information that was missed by the baseline, yielded results that were profusely analysed.
