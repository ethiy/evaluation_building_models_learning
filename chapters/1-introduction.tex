...
\section{Urban \texorpdfstring{\acrshort*{acr::3d}}{3D} reconstruction}
                ...
                \begin{center}
                    \ffigbox[\textwidth]{
                       \begin{subfloatrow}[3]
                            \centering
                            \ffigbox[.31\textwidth]{
                                \includegraphics[width=.27\textwidth]{images/introduction/mesh_model/point_cloud_5000}
                            }{
                                \caption{
                                    \gls{acr::3d} point cloud sampled from the surface of a building (\num{5000} points).
                                }
                            }
                            \quad
                            \ffigbox[.31\textwidth]{
                                \includegraphics[width=.27\textwidth]{images/introduction/mesh_model/poisson_mesh}
                            }{
                                \caption{
                                    \gls{acr::3d} mesh of a building surface (\num{28876} triangles).
                                }
                            }
                            \quad
                            \ffigbox[.31\textwidth]{
                                \includegraphics[width=.27\textwidth]{images/introduction/mesh_model/model}
                            }{
                                \caption{
                                    \gls{acr::3d} model of a building (\num{50} faces).
                                }
                            }
                       \end{subfloatrow}
                    }{
                        \caption[
                            Difference between a \acrshort*{acr::3d} point cloud, mesh and model of a building..
                        ]{
                            \label{fig::3dmodel_vs_3dmesh}
                            Difference between a \gls{acr::3d} point cloud, mesh and model of a building.
                            The point cloud (with \num{5000} points) does not provide any topological informations about the surface of the building.
                            A \gls{acr::3d} model is a special case of \gls{acr::3d} meshes which describes the surface of the object in a compact way.
                            The \gls{acr::3d} mesh is poor in \textit{implicit} semantics compared to the \gls{acr::3d} model, for which each architectural feature corresponds to a single geometric primitive.
                        }
                    }
                \end{center}
            \end{figure}
    ...
    \subsection{Challenges in \texorpdfstring{\gls*{acr::3d}}{3D} building modeling}
        ...
        \subsubsection{Modeling automation.}
            ...
            \begin{figure}[htb]
                \centering
                \includestandalone[mode=buildmissing, height=.4\textheight]{figures/modeling_approaches}            
                \caption[
