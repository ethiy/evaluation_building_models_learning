        ...
        \subsection{Context}
            \begin{frame}{\texorpdfstring{\acrshort*{acr::3d}}{3D} building model}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<1-> \acrshort{acr::3d} model \(\equiv\) generalization of the building surface.
            ...
            \begin{frame}{Applications}{Entertainement}
                \begin{figure}[H]
                    \centering
                    \animategraphics[autoplay, loop, width=\textwidth]{5}{images/not_used/time_machine_in_situ/frame-}{0}{169}
        ...
        \subsection{Motivation}
            ...
            \begin{frame}{Semantic errors}{Need for semantics}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<2-> Errors are \underline{geometric} and \underline{semantic} aware.
                \end{itemize}
            \end{frame}
        ...
        \begin{frame}{Semantic errors}{Constraints}
            \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                \item<1-> \textbf{Large-scale}: town or city level.
                    \only<2-6>{
                        \begin{itemize}
                            \item<2-> No reference models;
                            \item<3-> Independence towards the model origin:
                            \begin{itemize}
                ...
                \item<7-> \textbf{Automation}: without human operators.
                    \only<8->{
                        \begin{itemize}
                            \item<9-> Highly semantic task: not easy.
                        \end{itemize}
                    }
            \end{itemize}
        \end{frame}
