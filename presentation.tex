                ...
                \begin{columns}[T]
                    ...
                    \begin{column}{.5\textwidth}
                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                            ...
                            \item[\color{IGNRed} ---]<3-> \textcolor{IGNRed}{Low Compacity.}
                        \end{itemize}
                    \end{column}
                    \begin{column}{.5\textwidth}
                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                            \item<4-> Modeling.
                            \item[\color{IGNRed} ---]<5->\textcolor{IGNRed}{Low geometric fidelity.}
                            \item[\color{IGNGreen} +]<6-> \textcolor{IGNGreen}{High Compacity.}
                        \end{itemize}
                    \end{column}
                \end{columns}
            \end{frame}
            ...
            \begin{frame}{Error statistics}
                ...
                \only<4->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        ...
                        \item<6-> Dense scene:
                        \begin{itemize}[label=\(\rightarrow\)]
                            \item<7-> High \texttt{Facet errors} count;
                            \item<7-> Low \texttt{Building errors} count;
                        \end{itemize}
