...
\begin{document}
    ...
    \section{Introduction}
        \subsection{Context}
            \begin{frame}{Applications of \texorpdfstring{\acrshort*{acr::3d}}{3D} models}
                ...
                }
                {
                    \begin{figure}[H]
                        ...
                        \caption{Example of the use of city \acrshort{acr::3d} models in public consultation in Brest.}
                    \end{figure}
                }
                {
                    \begin{figure}[H]
                        ...
                        \caption{Example of the use of city \acrshort{acr::3d} models in video games.}
                    \end{figure}
                }
            \end{frame}
                ...
                \begin{columns}[T]
                    ...
                    \begin{column}{.5\textwidth}
                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                            ...
                            \item<2-> \textcolor{IGNGreen}{High geometric fidelity.}
                            \item<3-> \textcolor{IGNRed}{Low Compacity.}
                        \end{itemize}
                    \end{column}
                    \begin{column}{.5\textwidth}
                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                            \item<4-> Modeling.
                            \item<5->\textcolor{IGNRed}{Low geometric fidelity.}
                            \item<6-> \textcolor{IGNGreen}{High Compacity.}
                        \end{itemize}
                    \end{column}
                \end{columns}
            \end{frame}

            \begin{frame}{\texorpdfstring{\acrshort*{acr::3d}}{3D} models}{More than geometry}
                \centering
                \includestandalone[mode=buildnew, height=.6\textheight]{figures/model_information}\\
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item \acrshort{acr::3d} model = Geometry \only<2->{+ Topology} \only<3->{+ Semantics.}
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Modeling}{Different sources of errors}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<1-> Input imprecision: footprints, depth maps \dots
                    \item<2-> High (inter-) variance between building types;
                    \item<3-> High (intra-) variance between building features;
                \end{itemize}
            \end{frame}
        ...
        \subsection{Quality evaluation}
            \begin{frame}{Modeling errors}{Different point of views}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    ...
                    \item<3-> Errors in Modeling~\parencite{rottensteiner2012isprs}.
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Goal}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    ...
                    \item<2-> \underline{Define errors} that affects building \gls{acr::3d} models.
                \end{itemize}
            \end{frame}

            \begin{frame}{Challenges}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<1-> Large scale : small city level > \underline{\num{10000}} buildings.
            ...
            \begin{frame}{What do we want?}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}, itemsep=1em]
                    \item<1-> Readily available reference data;
        ...
        \subsection{General layout}
            ...
            \begin{frame}{Taxonomy}{Hierarchization and Modularity}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}, itemsep=2em]
                    ...
                    \item<2-> Modularity:
                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                            \item<3-> An error \(\equiv\) Composition of \underline{basic errors} common to all scenes.
                        \end{itemize}
                \end{itemize}
            \end{frame}
        ...
        \subsection{Roof modeling case}
            ...
            \begin{frame}{Atomic errors}{Over segmentation}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    ...
                    \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                        \item Segmentation issue (semantic):
                        \begin{itemize}
                            \item<1-2> Over segmentation.
                        \end{itemize}
                    \end{itemize}
                \end{itemize}
                \begin{overlayarea}{\textwidth}{.5\textheight}
            ...
            \begin{frame}{Atomic errors}{Imprecise border}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item \Acrfull{acr::2d} errors:
                    \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                        \item Border issue (geometric):
                        \begin{itemize}
                            \item<-2> Imprecise border.
                        \end{itemize}
                    \end{itemize}
                \end{itemize}
                \begin{overlayarea}{\textwidth}{.5\textheight}
    ...
    \section{Learning based evaluation}
        ...
        \subsection{\texorpdfstring{\acrshort*{acr::rmse}}{RMSE} for prediction}
            ...
            \begin{frame}{\texorpdfstring{\acrshort*{acr::rmse}}{RMSE} results}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<only@3> They are highly unbalanced\only<4>{: Most \texttt{Valid}  detected positive};
        ...
        \subsection{Feature baseline}
            ...
            \begin{frame}{Geometric features}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item Graph = \only<2->{\textcolor{darkgreen}{nodes(facets)}} \only<4->{ + \textcolor{blue}{edges(adjacency)}.}
    ...
    \section{Experiments}
                                ...
                                \begin{itemize}
                                    \item[\color{elancourt} \(\blacksquare\)]<2-> \textbf{Elancourt}: 
                                        \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                                            ...
                                            \item<4-> Orthoimage (RGB) resolution: \SI{0.06}{\m}
                                        \end{itemize}
                                \end{itemize}
                            }
                            \only<5-7>{
            ...
            \begin{frame}{Error statistics}
                ...
                \only<4->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        ...
                        \item<6-> Dense scene:
                        \begin{itemize}[label=\(\rightarrow\)]
                            \item<7-> High \texttt{Facet errros} count;
                            \item<7-> Low \texttt{Building errros} count;
                        \end{itemize}
                        \item<8-> Sparce scene: inverse.
                    \end{itemize}
                }
            \end{frame}
        ...
        \subsection{Results}
            \begin{frame}{Vanilla experiments}
                ...
                \only<11->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        \item<11-> Rare errors are hard to detect \(\longrightarrow\) \acrshort{acr::svm} is better.
                        \item<12-> \texttt{FOS} and \texttt{FIG} are very frequent \(\implies\) easily detected.
                        \item<13-> Geometric features are usually good enough.
                        \item<14-> In general:
                        \begin{itemize}
            ...
            \begin{frame}{Transferability experiments}
                ...
                \only<7->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        \item<7-> \texttt{Facets errors} > \texttt{Building errors}
                        \item<8-> \texttt{BOS} and \texttt{BUS} are hard to transfer.
                        \item<9-> Dense scenes: same behaviour.
                        \item<10-> Dense scenes: better for \texttt{Facet errors}.
                        \item<11-> External modalities are \underline{critical}.
                    \end{itemize}
                }
            \end{frame}
    ...
    \section{Advanced features}
        ...
        \subsection{Image features}
            \begin{frame}{Our needs}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<2-> Handles:
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        \item<2-> both \glspl{acr::dsm} and images (RGB).
                        \item<3-> Handle edges.
        ...
        \subsection{Experiments}
            ...
            \begin{frame}{Best results}
                ...
                \only<7->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        \item<7-> \acrshort{acr::svm} good for highly unbalanced errors.
                        \item<7-> Better feature extractors were beneficial.
                        \item<8-> \texttt{Building errors} > \SI{70}{\%}: Only \textbf{Elancourt}.
                        \item<8-> \texttt{Building errors} on dense scenes: Still to be improved.
                        \item<9-> \texttt{Facet errors} > \SI{70}{\%}.
                    \end{itemize}
                }
            \end{frame}
