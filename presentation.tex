        ...
        \subsection{\texorpdfstring{\acrshort*{acr::rmse}}{RMSE} for prediction}
            ...
            \begin{frame}{\texorpdfstring{\acrshort*{acr::rmse}}{RMSE} results}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<4-> There is a need for better features.
                \end{itemize}
            \end{frame}
        ...
        \subsection{Feature baseline}
            ...
            \begin{frame}{Geometric features}
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \item<6-> Features = Statistics on attributes (20).
                \end{itemize}
            \end{frame}
    ...
    \section{Experiments}
        \subsection{Dataset}
            ...
            \begin{frame}{Annotation procedure}
                ...
                \only<2>{
                    \includegraphics[width=\textwidth]{images/annotations/annotation_correct}
                }
                \only<3>{
                    \includegraphics[width=\textwidth]{images/annotations/annotation_annotation}
                }
            \end{frame}
        ...
        \subsection{Results}
            \begin{frame}{Vanilla experiments}
                \framesubtitle<1>{\texttt{Building errors}}
                \framesubtitle<2>{\texttt{Facet errors}}
                \centering
                \only<1>{
                ...
                \only<3->{
                    \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                        \item<3-> Rare errors are hard to detect \(\longrightarrow\) \acrshort{acr::svm} is better.
            ...
            \begin{frame}{Transferability experiments}
                ...
                \only<1-4>{
                    ...
                    \begin{tikzpicture}
                        ...
                        \node[align=center] at (2.5, .3) {\(\Delta F_{score}\)};
                    \end{tikzpicture}
                    \uncover<1->{
                        \normalsize
                        \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
        ...
        \subsection{Experiments}
            ...
            \begin{frame}{Parameters}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    ...
                    \begin{itemize}
                        \item<4-> \textbf{Geom.};
                        \item<4-> \textbf{Geom.} \(\oplus\) \textbf{S-Hei.};
                        \item<4-> \textbf{Geom.} \(\oplus\) \textbf{S(d)-Im.};
                        \item<4-> \textbf{Geom.} \(\oplus\) \textbf{S(c)-Im.};
                        \item<4-> \textbf{S(d)-All} = \textbf{Geom.} \(\oplus\) \textbf{S-Hei.} \(\oplus\) \textbf{S(d)-Im.}.
                        \item<4-> \textbf{S(c)-All} = \textbf{Geom.} \(\oplus\) \textbf{S-Hei.} \(\oplus\) \textbf{S(c)-Im.}.
                    \end{itemize}
                \end{itemize}
            \end{frame}
