    ...
    \section{Learned evaluation}
        ...
        \subsection{Advanced graph features}
            ...
            \begin{frame}{Graph kernels}
                ...
                \alt<2>{
                    \begin{figure}[H]
                        ...
                        \includestandalone[mode=buildnew, width=.45\textwidth]{figures/features/graph_kernels/tottering}
                    \end{figure}
                }{
            ...
            \begin{frame}{Advanced graph features}
                \centering
                \includestandalone[mode=buildnew, width=.6\textwidth]{figures/features/geometric_kernels_animated}
            \end{frame}
        ...
        \subsection{Advanced image features}
            ...
            \begin{frame}{\texorpdfstring{\acrshort*{acr::scatnet}}{ScatNet} filters}
                ...
                \alt<2>{
                    ...
                    \includegraphics[width=.4\textwidth]{images/related_work/first_layer_cnn}\\
