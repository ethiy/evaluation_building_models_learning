    ...
    \section{Learned evaluation}
                ...
                \only<1-4>{
                    \begin{columns}[T]
                        ...
                        \begin{column}{.56\textwidth}
                            \centering
                            \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                                \item<2-> Quadratic form with \(P_{\times}\) \(\implies\) invariance to:
                                    \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                                        \item<3-> permutation;
                                        \item<4-> graph size;
                                    \end{itemize}
            ...
            \begin{frame}{Graph Hopper kernel}
                \begin{overlayarea}{\textwidth}{.5\textheight}
                    \only<1>{
                        \begin{figure}[H]
                            \centering
                            \caption{Tottering: isolated nodes are ignored.}
                ...
                \end{overlayarea}
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<2-> Compare \underline{paths} instead;
                    \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
        ...
        \subsection{Advanced image features}
            ...
            \begin{frame}{\texorpdfstring{\acrshort*{acr::scatnet}}{ScatNet} filters}
                ...
                \includegraphics[width=\textwidth]{images/related_work/first_layer_cnn}
            \end{frame}
