    ...
    \section{Introduction}
        \subsection{Context}
            ...
            \begin{frame}{Reconstruction \texttt{vs.} Modeling}
                ...
                \vfill
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<7-> Literature: trade off fidelity \(\vert\) compacity.
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Modeling}{Multiple sources of errors}
                ...
                \vfill
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<4-> \(\uparrow\) \gls{acr::lod} \(\longleftrightarrow\) \(\downarrow\) coverage of \gls{acr::3d} models~\parencite{stoter2013three}.
                \end{itemize}
        ...
        \subsection{Quality evaluation}
            ...
            \begin{frame}{Goal of the thesis}
                ...
                \vfill
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<3-> Errors = Geometry \(\wedge\) Topology;
                    \item<4-> Errors \(\neq\) Exhaustivity \(\vee\) Up-to-dateness.
                \end{itemize}
            \end{frame}
    ...
    \section{Advanced features}
        ...
        \subsection{Image features}
            \begin{frame}{Our needs}
                ...
                \vfill
                \uncover<5->{
                    Proposed solution: \gls{acr::scatnet}~\parencite{mallat2012group}.
                }
            \end{frame}
