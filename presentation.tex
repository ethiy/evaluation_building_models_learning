    ...
    \section{Learning based evaluation}
        ...
        \subsection{Is \texorpdfstring{\acrshort*{acr::rmse}}{RMSE} sufficient?}
            \begin{frame}{\texorpdfstring{\acrshort*{acr::rmse}}{RMSE} as a feature}
                \centering
                \includestandalone[mode=buildnew, width=\textwidth]{figures/features/height/rmse_animated}
            \end{frame}
        ...
        \subsection{Feature baseline}
            ...
            \begin{frame}{Geometric features}
                \centering
                \includestandalone[mode=buildnew, width=.68\textwidth]{figures/features/geometric/baseline_animated}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
            ...
            \begin{frame}{Height based features}
                \centering
                \includestandalone[mode=buildnew, width=\textwidth]{figures/features/height/baseline_animated}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
            ...
            \begin{frame}{Image based features}
                \centering
                \includestandalone[mode=buildnew, height=.7\textheight]{figures/features/image/baseline_animated}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
    ...
    \section{Experiments}
        \subsection{Dataset}
            ...
            \begin{frame}{Annotation procedure}
                \centering
                \only<1>{
                    \includegraphics[width=.8\textwidth]{images/annotations/rendering}
                }
                \only<2>{
                    \includegraphics[width=.8\textwidth]{images/annotations/correction}
                }
                \only<3->{
                    \includegraphics[width=.8\textwidth]{images/annotations/annotation}
                }
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
