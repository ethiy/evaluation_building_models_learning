    ...
    \section{Learned evaluation}
        ...
        \subsection{Advanced image features}
            ...
            \begin{frame}{Why using \texorpdfstring{\acrshort*{acr::scatnet}}{ScatNet}}
                \begin{itemize}
                    \item[\textbullet] Filters are hardcoded not learned:
                    \begin{itemize}
                        \item[\color{IGNDarkGreen} +] No need for a large dataset;
                        \item[\color{red} ---] Features: not adaptable.
                    \end{itemize}
                    \item[\color{IGNDarkGreen} +] Interpretable;
                \end{itemize}
            \end{frame}
