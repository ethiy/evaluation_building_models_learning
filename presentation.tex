...
\begin{document}
    ...
    \section{Semantic evaluation}
        ...
        \subsection{General layout}
            \begin{frame}{\texttt{Qualifiability}}
                \begin{itemize}
                    \item<1-> \texttt{Unqualifiable} model:
                        \onslide<2->{
                            \only<2>{
                                \begin{itemize}
                                    \item Wrong geometrical format\footcite{ledoux2013validation};
                                \end{itemize}
                            }
                            \only<3>{
                                \begin{itemize}
                    ...
                    \item<6-> \texttt{Qualifiable} model.
                \end{itemize}
            \end{frame}
            % \begin{frame}{Error classification}{\texttt{Atomic errors}}
            %     \begin{itemize}
            %         \item<1-> \gls{acr::2d} errors:
            %             \onslide<>{
            %                 \only<>{

            %                 }
            %             }
            %         \item<6-> \gls{acr::3d} error:
            %     \end{itemize}
            % \end{frame}
