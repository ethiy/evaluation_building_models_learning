...
\begin{document}
    ...
    \section{Introduction}        
        ...
        \begin{frame}{Goal}
            \begin{itemize}
                \item<1-> Define errors that can affect building \gls{acr::3d} models.
                \item<2-> Devise a method for error detection.
            \end{itemize}
            \begin{itemize}
                \item<1-> Errors not in format but in fidelity to the real world.
                \item<1-> Generalization= compromise fidelity vs. simplification => semantics.
            \end{itemize}
        \end{frame}
        \begin{frame}{Constraints}
            ...
            \begin{itemize}
                ...
                \item<3-> \underline{Scalability}, of the evaluation method.
            \end{itemize}
        \end{frame}
