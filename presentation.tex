    ...
    \section{Experimental study}
        \subsection{Dataset}
            ...
            \begin{frame}{Error statistics}
                ...
                \only<2>{
                    \includestandalone[mode=buildnew, height=.7\textheight]{figures/datasets/lod1_stats}
                }
                \only<3>{
        ...
        \subsection{Set up}
            ...
            \begin{frame}{Experiment types}
                \centering
                \includestandalone[mode=buildnew, height=.7\textheight]{figures/scalabitity_graph_animated}
            \end{frame}
