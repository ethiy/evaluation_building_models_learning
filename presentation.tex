    ...
    \section{Introduction}
        \subsection{Context}
            ...
            \begin{frame}{Reconstruction \texttt{vs.} Modeling}
                ...
                \vfill
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<7-> Literature: trade off fidelity/compacity.
                \end{itemize}
            \end{frame}
            ...
            \begin{frame}{Modeling}{Multiple sources of errors}
                ...
                \vfill
                \begin{itemize}[label=\(\blacktriangleright\), font=\color{IGNGreen}]
                    \item<4-> \(\uparrow\) \acrshort{acr::lod} \(\longleftrightarrow\) \(\downarrow\) coverage of \gls{acr::3d} models~\parencite{stoter2013three}.
                \end{itemize}
            \end{frame}
    ...
    \section{Experiments}
        \subsection{Dataset}
            ...
            \begin{frame}{Error statistics}
                \framesubtitle<1>{\acrshort{acr::lod}-2 level}
