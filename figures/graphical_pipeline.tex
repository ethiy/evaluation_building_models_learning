...
\begin{document}
    \begin{tikzpicture}
        ...
        \path (residual.west) + (-1, 0) node[anchor=east, visible on=<2->] (facet_graph) {\includestandalone[mode=buildmissing, height=1.5cm]{figures/graphical_abstract/building_graph}};
		...
		\path (frame.south) + (0, -1.5) node[anchor=north] (errors) {\includestandalone[mode=buildmissing, height=1.5cm]{figures/graphical_abstract/building_errors}};
