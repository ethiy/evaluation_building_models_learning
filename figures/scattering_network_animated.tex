...
\begin{document}
    ...
    \begin{tikzpicture}[grow=south]
        \node (x) {\includegraphics[width=3cm]{images/scatnet/x}}
            ...
            \path[draw, blue, ->, visible on=<6>] (x1_2.south) -- ($(x1_2.south) + (0, -1)$) node[anchor=north] (s1) {\includegraphics[height=3cm]{images/scatnet/s1}};
            ...
            \path[visible on=<7>] (x1_2.south) -- ($(x1_2.south) + (0, -.5)$) node[blue, anchor=north] (s1_2) {\small $\dots (I \times L) \dots$};
