...
\begin{document}
    ...
    \begin{tikzpicture}[grow=south]
        \node[visible on=<-13>] (x) {\includegraphics[width=3cm]{images/scatnet/x}}
            ...
            \path[draw, blue, ->, visible on=<7>] (x1_2.south) -- ($(x1_2.south) + (0, -1)$) node[anchor=north] (s1) {\includegraphics[width=6cm]{images/scatnet/s1}};
            ...
            \path[visible on=<11>] ($(x1_1_3.south)!.5!(x1_3_1.south)$) + (0, -.5) node[anchor=south] (s2) {\includegraphics[width=12cm]{images/scatnet/s2}};
            \path[visible on=<13>] ($(x1_1_3.south)!.5!(x1_3_1.south)$) + (0, -.5) node[anchor=north] (s3) {\large \(\vdots\)};
            ...
            \path (x) node[signal, visible on=<14->, blue] (x) {\Large \(x\)};
