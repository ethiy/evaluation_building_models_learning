    ...
    \begin{tikzpicture} 
        \begin{axis}[
            ...
            \addplot+[
                ...
                fill=green!40,
                draw=green
            ] table[x=x, y=y, meta index=2, visible on=<1>] {\BOS};
            \addplot+[
                bar shift = -5pt,
                fill=cyan!40,
                draw=cyan
            ] table[x=x, y=y, meta index=2, visible on=<1>] {\BUS};
            \addplot+[
                bar shift = 5pt,
                fill=red!40,
                draw=red
            ...
            \addplot+[
                ...
                fill=green!40,
                draw=green
            ] table[x=x, y=y, meta index=2, visible on=<3->] {\BOS};
            \addplot+[
                bar shift = -5pt,
                fill=cyan!40,
                draw=cyan
            ] table[x=x, y=y, meta index=2, visible on=<4->] {\BUS};
            \addplot+[
                bar shift = 5pt,
                fill=red!40,
                draw=red
