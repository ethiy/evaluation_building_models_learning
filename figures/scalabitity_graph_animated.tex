...
\begin{document}
	...
	\begin{tikzpicture}
        ...
        \path[edge, out=70,in=110,looseness=8, visible on=<2->] (z1) to node[midway, above, align=center] {Vanila} (z1);
        \path[edge, out=70,in=110,looseness=8, visible on=<2->] (z2) to node[midway, above, align=center] {Vanila} (z2);
        \path[edge, out=70,in=110,looseness=8, visible on=<2->] (z3) to node[midway, above, align=center] {Vanila} (z3);
