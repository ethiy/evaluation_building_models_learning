...
\begin{document}
    \begin{tikzpicture}
        ...
        \path (f) + (-2, -1) node[darkgreen, visible on=<3->] (facet_attributes) {\tiny \(\begin{bmatrix}
        ...
        \path[draw, ->, line width=1pt, rounded corners=10pt, darkgreen, visible on=<3->] (f.185) -- (facet_attributes.north);
