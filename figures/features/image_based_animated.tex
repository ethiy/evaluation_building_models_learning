...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\path (image) + (-.25, 0) node[visible on=<2>] (pixel_segment) {\includestandalone[width=5cm]{figures/features/image_based}};

		\path (image) node[visible on=<3->] (segment_hist) {\includegraphics[width=5cm, angle=270]{images/introduction/graphical_abstract/orthoprojection}};
