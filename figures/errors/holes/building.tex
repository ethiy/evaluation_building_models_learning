...
\begin{document}
    ...
    \begin{3dtikzpicture}{15}{20}[scale=1]
        ...
        \begin{scope}[canvas is zx plane at y=3]
          	\path[face] (0,1.5) rectangle (2,2.75);
        \end{scope}
        \begin{scope}[canvas is zy plane at x=1.5]
          	\path[face, dashed] (0,2) rectangle (2,3);
        \end{scope}
        \begin{scope}[canvas is zy plane at x=2.75]
          	\path[face] (0,2) rectangle (2,3);
        \end{scope}
        \begin{scope}[canvas is zx plane at y=2]
          	\path[face, dashed] (0,1.5) rectangle (2,2.75);
        \end{scope}

        \begin{scope}[canvas is yx plane at z=2]
            \path[face, even odd rule] (0,0) rectangle (5,4) (3,2.75) rectangle (2,1.5);
        \end{scope}

        \begin{scope}[canvas is zy plane at x=0]
          	\path[face] (0,0) rectangle (2,5);
        \end{scope}
