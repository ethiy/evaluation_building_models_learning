...
\begin{document}
    ...
    \begin{3dtikzpicture}{45}{45}[scale=1]
        \begin{scope}[canvas is zy plane at x=3]
            \path[face, dashed] (0,-.5) -- (1.875,-0.5) -- (2.5,2) -- (2,4) -- (0,4) -- cycle;
		\end{scope}
        \begin{scope}[canvas is zx plane at y=4]
          	\path[face, dashed] (0,0) rectangle (2,3);
        \end{scope}
        \path[face] (0,.5,1.875) -- (0,2,2.5) -- (3,2,2.5) -- (3,-.5,1.875) -- cycle;
        \path[face] (0,4,2)-- (3,4,2) -- (3,2,2.5) -- (0,2,2.5) -- cycle;
        \begin{scope}[canvas is zy plane at x=0]
          	\path[face, shade] (0,.5) -- (1.875,.5) -- (2.5,2) -- (2,4) -- (0,4) -- cycle;
        \end{scope}
        \path[face, left color=magenta!20, right color=magenta] (0,.5,0) -- (0,.5,1.875) -- (3,-.5,1.875) -- (3,-.5,0) -- cycle;
    \end{3dtikzpicture}
\end{document}