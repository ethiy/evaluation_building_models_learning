...
\begin{document}
    \begin{tikzpicture}
        \path (0, 0) node (sampled_pc) {\includegraphics[width=2cm]{images/context/sampled_pc}};
        ...
        \path (3d_reconstruction.east) node[anchor=west] (3d_model) {\includegraphics[width=2cm]{images/context/3d_model}};
