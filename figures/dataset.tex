...
\begin{document}
    \begin{tikzpicture}
        \node[visible on=<2->] (nantes) at (0,0) {\includegraphics[height=10cm]{images/datasets/nantes_samples}};
        ...
        \path (nantes.west) + (-1, 0) node[anchor=east] (elancourt) {\includegraphics[height=10cm]{images/datasets/elancourt_samples}};
        ...
        \path (nantes.east) + (1, 0) node[anchor=west, visible on=<3->] (paris13) {\includegraphics[height=10cm]{images/datasets/paris-13_samples}};
